...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        track_values = orm['speakers.Speaker'].objects.distinct('track').values_list('track', flat=True)
        for value in track_values:
            orm['speakers.Track'].objects.get_or_create(name=value)

        # copy speaker track to track_tmp and get track id for track field
        speakers = orm['speakers.Speaker'].objects.all()
        for speaker in speakers:
            speaker.track_tmp = speaker.track
            speaker.save()
