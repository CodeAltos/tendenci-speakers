...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Speaker.allow_user_view'
        db.alter_column(u'speakers_speaker', 'allow_user_view', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'Speaker.allow_anonymous_view'
        db.alter_column(u'speakers_speaker', 'allow_anonymous_view', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'Speaker.status'
        db.alter_column(u'speakers_speaker', 'status', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'Speaker.allow_user_edit'
        db.alter_column(u'speakers_speaker', 'allow_user_edit', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'Speaker.allow_member_view'
        db.alter_column(u'speakers_speaker', 'allow_member_view', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'Speaker.allow_member_edit'
        db.alter_column(u'speakers_speaker', 'allow_member_edit', self.gf('django.db.models.fields.NullBooleanField')(null=True))

    def backwards(self, orm):

        # Changing field 'Speaker.allow_user_view'
        db.alter_column(u'speakers_speaker', 'allow_user_view', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Speaker.allow_anonymous_view'
        db.alter_column(u'speakers_speaker', 'allow_anonymous_view', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Speaker.status'
        db.alter_column(u'speakers_speaker', 'status', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Speaker.allow_user_edit'
        db.alter_column(u'speakers_speaker', 'allow_user_edit', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Speaker.allow_member_view'
        db.alter_column(u'speakers_speaker', 'allow_member_view', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Speaker.allow_member_edit'
        db.alter_column(u'speakers_speaker', 'allow_member_edit', self.gf('django.db.models.fields.BooleanField')())
    ...
    models = {
        ...
        u'speakers.speaker': {
            ...
            'create_dt': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "u'speakers_speaker_creator'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['auth.User']"}),
            'creator_username': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'email': ('django.db.models.fields.EmailField', [], {'max_length': '75', 'null': 'True', 'blank': 'True'}),
            'entity': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'speakers_speaker_entity'", 'on_delete': 'models.SET_NULL', 'default': 'None', 'to': u"orm['entities.Entity']", 'blank': 'True', 'null': 'True'}),
            ...
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "u'speakers_speaker_owner'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['auth.User']"}),
            'owner_username': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            ...
            'track': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['speakers.Track']", 'null': 'True'}),
            'twitter': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
            'update_dt': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'})
        },
        u'speakers.speakerfile': {
            'Meta': {'ordering': "('position',)", 'object_name': 'SpeakerFile', '_ormbases': [u'files.File']},
