...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('speakers_speaker', 'track')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Speaker.track'
        raise RuntimeError("Cannot reverse this migration. 'Speaker.track' and its values cannot be restored.")
