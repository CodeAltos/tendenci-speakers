...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Track'
        db.create_table('speakers_track', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
        db.send_create_signal('speakers', ['Track'])

        # Adding field 'Speaker.track_tmp'
        db.add_column('speakers_speaker', 'track_tmp',
    ...
    def backwards(self, orm):
        ...
        db.delete_table('speakers_track')

        # Deleting field 'Speaker.track_tmp'
        db.delete_column('speakers_speaker', 'track_tmp')
