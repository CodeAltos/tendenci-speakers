...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Speaker.track'
        db.add_column('speakers_speaker', 'track',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['speakers.Track'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Speaker.track'
        db.delete_column('speakers_speaker', 'track_id')
    ...
    models = {
        ...
        'speakers.speaker': {
            ...
            'track': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['speakers.Track']", 'null': 'True'}),
            'track_tmp': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '50'}),
